...
global main := Func("script_6")
$.on.Call("f1", main)
$.on.Call("f4", Func("script_2"))
$.on.Call("f5", Func("script_1"))
script_1() {
  $.beep.Call()
  $.reload.Call()
}
...
script_6() {
  $.on.Call("f2", Func("script_5"))
  $.on.Call("f2.text", Func("script_4"))
  $.trigger.Call("f2.text")
  $.setTimeout.Call(Func("script_3"), 1000)
}
