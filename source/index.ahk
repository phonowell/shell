...
__mixin__.Call($, {delete: __delete__})
...
shell_8(__func__, __args__) {
  return __func__.Call(__args__*)
}
shell_9(__func__, __args__*) {
  return __delay__.Call(Func("shell_8").Bind(__func__, __args__), 1)
}
shell_10() {
...
shell_14(__func__, __tsThrottle__, __index__) {
  __func__.Call()
  __tsThrottle__[__ci_shell__.Call(__index__)] := __now__.Call()
}
shell_15(__tThrottle__, __func__, __tsThrottle__, __wait__, __index__) {
  __clearTimeout__.Call(__tThrottle__[__ci_shell__.Call(__index__)])
  __tThrottle__[__ci_shell__.Call(__index__)] := __setTimeout__.Call(Func("shell_14").Bind(__func__, __tsThrottle__, __index__), __tsThrottle__[__ci_shell__.Call(__index__)] - __now__.Call() + __wait__)
}
...
shell_25(__func__, __wait__, __args__*) {
  __timer__ := __setTimeout__.Call(Func("shell_24").Bind(__func__, __args__), __wait__)
  return __timer__
}
shell_26() {
  __setTimeout__ := __shell_module_77__
...
shell_27(__tDebounce__, __func__, __wait__, __index__) {
  __clearTimeout__.Call(__tDebounce__[__ci_shell__.Call(__index__)])
  __tDebounce__[__ci_shell__.Call(__index__)] := __setTimeout__.Call(__func__, __wait__)
}
...
shell_106(__list__, __size__ := 1) {
  __listNew__ := []
  __len__ := __length__.Call(__list__)
  __i__ := 0
  while (__i__ < __len__ / __size__) {
    ...
    while (__j__ < __size__) {
      ...
      __push__.Call(__listTemp__, __list__[__ci_shell__.Call(__index__)])
      __j__++
    }
