...
global __ci_shell__ := Func("shell_225")
global $ := {}
$.abs := Func("shell_224")
$.activate := Func("shell_223")
$.add := Func("shell_222")
$.alert := Func("shell_221")
$.beep := Func("shell_219")
$.bind := Func("shell_218")
$.blockInput := Func("shell_217")
$.ceil := Func("shell_216")
$.chunk := Func("shell_215")
$.clearInterval := Func("shell_214")
$.clearTimeout := Func("shell_213")
$.click := Func("shell_212")
$.clone := Func("shell_211")
$.close := Func("shell_210")
$.compact := Func("shell_209")
$.concat := Func("shell_207")
$.confirm := Func("shell_206")
global __iDebounce__ := 0
global __tDebounce__ := {}
$.debounce := Func("shell_205")
$.defer := Func("shell_203")
$.delay := Func("shell_201")
$.drop := Func("shell_199")
$.each := Func("shell_197")
class EmitterShellX {
  bus := []
  emit := Func("shell_196").Bind(this)
  off := Func("shell_195").Bind(this)
  on := Func("shell_194").Bind(this)
}
$.emitter := Func("shell_193")
global __eq__ := Func("shell_192")
$.eq := __eq__
$.exec := Func("shell_191")
$.exit := Func("shell_190")
class FileShellX {
  ...
  append := Func("shell_189").Bind(this)
  exist := Func("shell_188").Bind(this)
  delete := Func("shell_187").Bind(this)
  load := Func("shell_186").Bind(this)
  save := Func("shell_185").Bind(this)
}
$.file := Func("shell_184")
$.filter := Func("shell_183")
$.findColor := Func("shell_182")
$.findImage := Func("shell_181")
$.first := Func("shell_180")
$.head := $.first
$.floor := Func("shell_179")
$.forEach := Func("shell_178")
$.formatHotkey := Func("shell_177")
global __formatKeyFormatHotkey__ := Func("shell_176")
global __pickPrefixFormatHotkey__ := Func("shell_175")
$.get := Func("shell_174")
$.getColor := Func("shell_173")
$.getPosition := Func("shell_172")
$.getState := Func("shell_171")
$.gt := Func("shell_170")
$.gte := Func("shell_169")
$.i := Func("shell_168")
$.includes := Func("shell_167")
$.info := Func("shell_166")
$.isActive := Func("shell_165")
$.isArray := Func("shell_164")
$.isExisted := Func("shell_163")
$.isFunction := Func("shell_162")
$.isNumber := Func("shell_161")
$.isObject := Func("shell_160")
$.isString := Func("shell_159")
$.join := Func("shell_158")
class KeyBindingShellX {
  mapBound := {}
  mapCallback := {}
  add := Func("shell_157").Bind(this)
  fire := Func("shell_156").Bind(this)
  init := Func("shell_153").Bind(this)
  off := Func("shell_151").Bind(this)
  on := Func("shell_150").Bind(this)
  remove := Func("shell_149").Bind(this)
}
...
$.keys := Func("shell_147")
$.last := Func("shell_146")
$.length := Func("shell_145")
$.lt := Func("shell_144")
$.lte := Func("shell_143")
$.map := Func("shell_142")
$.maximize := Func("shell_141")
$.minimize := Func("shell_140")
$.mixin := Func("shell_139")
$.mod := Func("shell_138")
$.move := Func("shell_137")
$.noop := Func("shell_136")
$.now := Func("shell_135")
...
$.open := Func("shell_131")
$.play := Func("shell_130")
$.press := Func("shell_129")
global __formatInputPress__ := Func("shell_128")
global __validateInputPress__ := Func("shell_127")
$.push := Func("shell_126")
$.random := Func("shell_125")
$.range := Func("shell_124")
$.reload := Func("shell_123")
$.replace := Func("shell_122")
$.reverse := Func("shell_121")
$.round := Func("shell_120")
$.setFixed := Func("shell_119")
$.setInterval := Func("shell_118")
$.setStyle := Func("shell_117")
$.setTimeout := Func("shell_116")
$.shuffle := Func("shell_115").Bind(__split__)
$.sleep := Func("shell_114")
$.slice := Func("shell_113")
global __pickArgumentSlice__ := Func("shell_112")
$.sort := Func("shell_111")
$.split := Func("shell_110")
$.startsWith := Func("shell_109")
$.sum := Func("shell_108")
$.suspend := Func("shell_107")
$.tail := Func("shell_106")
$.take := Func("shell_105")
global __iThrottle__ := 0
global __tThrottle__ := {}
global __tsThrottle__ := {}
$.throttle := Func("shell_104")
$.toLowerCase := Func("shell_101")
$.toLower := $.toLowerCase
$.toString := Func("shell_100")
$.toUpperCase := Func("shell_99")
$.toUpper := $.toUpperCase
$.trim := Func("shell_98")
$.trimEnd := Func("shell_97")
$.trimStart := Func("shell_96")
$.type := Func("shell_95")
$.uniq := Func("shell_94")
$.values := Func("shell_93")
$.VERSION := "0.0.18"
$.wait := Func("shell_92")
(Func("shell_91")).Call()
(Func("shell_90")).Call()
...
shell_67() {
  ...
  $.each.Call(list, Func("shell_66").Bind(listA, length))
...
shell_82() {
  ...
  string := $.join.Call(($.map.Call(listA, Func("shell_81"))), ",")
...
shell_90() {
  ...
  $.close.Call(name)
  $.open.Call(name)
  $.wait.Call(name, Func("shell_89").Bind(name))
}
shell_91() {
  n := 42
  result := $.abs.Call(n)
...
shell_102(callback, index) {
  callback.Call()
  __tsThrottle__[__ci_shell__.Call(index)] := $.now.Call()
}
shell_103(callback, time, index) {
  $.clearTimeout.Call(__tThrottle__[__ci_shell__.Call(index)])
  __tThrottle__[__ci_shell__.Call(index)] := $.setTimeout.Call(Func("shell_102").Bind(callback, index), __tsThrottle__[__ci_shell__.Call(index)] - $.now.Call() + time)
}
shell_104(time, callback) {
  __iThrottle__++
  __tsThrottle__[__ci_shell__.Call(__iThrottle__)] := 0
  return Func("shell_103").Bind(callback, time, __iThrottle__)
}
shell_105(list, count := 1) {
...
shell_109(text, string) {
  return (InStr(text, string)) == 1
}
shell_110(ipt, delimiter) {
...
shell_122(ipt, searchment, replacement, limit := -1) {
...
shell_133(callback) {
  ...
  return Func("shell_132").Bind(__i__, callback)
}
shell_134(list, n := 0) {
  if (n >= 0) {
...
shell_137(point := "", speed := 0) {
  MouseMove, point[1], point[2], speed
}
shell_138(dividend, divisor) {
...
shell_149(this, key) {
  ...
  __listNew__ := $.filter.Call(this.mapCallback[__ci_shell__.Call(key)], Func("shell_148").Bind(__name__))
...
shell_153(this, key) {
  ...
  this.mapCallback[__ci_shell__.Call(key)] := []
  __fn__ := Func("shell_152").Bind(key, this)
...
shell_156(this, key) {
  ...
  if (__name__) {
    __list__ := $.filter.Call(__list__, Func("shell_155").Bind(__name__))
  }
  $.forEach.Call(__list__, Func("shell_154"))
}
...
shell_191(__input__, __callback__) {
...
shell_199(list, n := 1) {
  return $.filter.Call(list, Func("shell_198").Bind(n))
}
shell_200(callback, args) {
  callback.Call(args*)
}
shell_201(callback, time, args*) {
  __timer__ := $.setTimeout.Call(Func("shell_200").Bind(callback, args), time)
  return __timer__
}
shell_202(callback, args) {
  callback.Call(args*)
}
shell_203(callback, args*) {
  return $.delay.Call(Func("shell_202").Bind(callback, args), 1)
}
shell_204(callback, time, index) {
...
shell_205(time, callback) {
  __iDebounce__++
  return Func("shell_204").Bind(callback, time, __iDebounce__)
}
shell_206(text, callback) {
...
shell_209(list) {
  return $.filter.Call(list, Func("shell_208"))
}
shell_210(target) {
  if !(target) {
...
shell_221(message*) {
  __msg__ := $.join.Call(($.map.Call(message, Func("shell_220"))), ", ")
  MsgBox, % __msg__
}
shell_222(args*) {
  __result__ := 0
