...
global __rf_shell__ := Func("shell_330")
global __ci_shell__ := Func("shell_329")
...
global __shell_module_1__ := (Func("shell_328")).Call()
global __shell_module_4__ := (Func("shell_326")).Call()
global __shell_module_6__ := (Func("shell_324")).Call()
global __shell_module_10__ := (Func("shell_322")).Call()
global __shell_module_11__ := (Func("shell_320")).Call()
global __shell_module_20__ := (Func("shell_318")).Call()
global __shell_module_22__ := (Func("shell_316")).Call()
global __shell_module_27__ := (Func("shell_314")).Call()
global __shell_module_30__ := (Func("shell_312")).Call()
global __shell_module_35__ := (Func("shell_310")).Call()
global __shell_module_40__ := (Func("shell_308")).Call()
global __shell_module_41__ := (Func("shell_306")).Call()
global __shell_module_42__ := (Func("shell_304")).Call()
global __shell_module_49__ := (Func("shell_302")).Call()
global __shell_module_50__ := (Func("shell_300")).Call()
global __shell_module_52__ := (Func("shell_298")).Call()
global __shell_module_53__ := (Func("shell_296")).Call()
global __shell_module_56__ := (Func("shell_294")).Call()
global __shell_module_58__ := (Func("shell_292")).Call()
global __shell_module_59__ := (Func("shell_290")).Call()
global __shell_module_61__ := (Func("shell_288")).Call()
global __shell_module_67__ := (Func("shell_285")).Call()
global __shell_module_69__ := (Func("shell_283")).Call()
global __shell_module_70__ := (Func("shell_281")).Call()
global __shell_module_78__ := (Func("shell_279")).Call()
global __shell_module_79__ := (Func("shell_277")).Call()
global __shell_module_80__ := (Func("shell_275")).Call()
global __shell_module_81__ := (Func("shell_273")).Call()
...
(Func("shell_257")).Call()
global __shell_module_2__ := (Func("shell_256")).Call()
global __shell_module_3__ := (Func("shell_254")).Call()
global __shell_module_12__ := (Func("shell_252")).Call()
global __shell_module_16__ := (Func("shell_250")).Call()
global __shell_module_26__ := (Func("shell_248")).Call()
global __shell_module_33__ := (Func("shell_246")).Call()
global __shell_module_34__ := (Func("shell_244")).Call()
global __shell_module_38__ := (Func("shell_242")).Call()
global __shell_module_44__ := (Func("shell_240")).Call()
global __shell_module_45__ := (Func("shell_238")).Call()
global __shell_module_46__ := (Func("shell_236")).Call()
global __shell_module_57__ := (Func("shell_234")).Call()
global __shell_module_62__ := (Func("shell_232")).Call()
global __shell_module_63__ := (Func("shell_230")).Call()
global __shell_module_71__ := (Func("shell_228")).Call()
...
class FileShell {
  ...
  append := Func("shell_226").Bind(this)
  isExists := Func("shell_225").Bind(this)
  read := Func("shell_224").Bind(this)
  remove := Func("shell_223").Bind(this)
  write := Func("shell_222").Bind(this)
}
__rf_shell__.Call(__noop__, "#rf/shell/1").Call(FileShell)
__noop__ := __shell_module_58__
class MathShell {
  abs := Func("shell_221").Bind(this)
  ceil := Func("shell_220").Bind(this)
  floor := Func("shell_219").Bind(this)
  max := Func("shell_218").Bind(this)
  min := Func("shell_217").Bind(this)
  round := Func("shell_216").Bind(this)
}
__rf_shell__.Call(__noop__, "#rf/shell/2").Call(MathShell)
global __shell_module_84__ := (Func("shell_215")).Call()
__noop__ := __shell_module_58__
class WindowShell {
  __New(exe) {
    this.exe := "ahk_exe " . (exe) . ""
  }
  blur := Func("shell_214").Bind(this)
  close := Func("shell_213").Bind(this)
  focus := Func("shell_212").Bind(this)
  getBounds := Func("shell_211").Bind(this)
  hide := Func("shell_210").Bind(this)
  isActive := Func("shell_209").Bind(this)
  isExists := Func("shell_208").Bind(this)
  isFullScreen := Func("shell_207").Bind(this)
  kill := Func("shell_206").Bind(this)
  maximize := Func("shell_205").Bind(this)
  minimize := Func("shell_204").Bind(this)
  restore := Func("shell_203").Bind(this)
  setPriority := Func("shell_202").Bind(this)
  setStyle := Func("shell_201").Bind(this)
  show := Func("shell_200").Bind(this)
  wait := Func("shell_199").Bind(this)
}
...
(Func("shell_174")).Call()
global __shell_module_23__ := (Func("shell_173")).Call()
global __shell_module_31__ := (Func("shell_171")).Call()
global __shell_module_37__ := (Func("shell_169")).Call()
global __shell_module_51__ := (Func("shell_167")).Call()
global __shell_module_64__ := (Func("shell_166")).Call()
global __shell_module_66__ := (Func("shell_164")).Call()
global __shell_module_68__ := (Func("shell_162")).Call()
global __shell_module_73__ := (Func("shell_160")).Call()
...
shell_141() {
  ...
  if !((__rf_shell__.Call(__toString__, "#rf/shell/245").Call({a: 1})) == "") {
    throw __rf_shell__.Call(__toString__, "#rf/shell/246").Call({a: 1})
  }
}
shell_142() {
  result := __rf_shell__.Call(__split__, "#rf/shell/247").Call("test", ",")
  if !((__rf_shell__.Call(__length__, "#rf/shell/248").Call(result)) == 1) {
    throw result
  }
  if !(result[1] == "test") {
    throw result
...
shell_143() {
  result := __rf_shell__.Call(__split__, "#rf/shell/249").Call("a,b,c", ",")
  if !((__rf_shell__.Call(__length__, "#rf/shell/250").Call(result)) == 3) {
    throw result
  }
...
shell_144() {
  list := [0, 1, 2]
  first := __rf_shell__.Call(__shift__, "#rf/shell/251").Call(list)
  if !(first == 0) {
    throw 0
  }
...
shell_145() {
  list := [0]
  __rf_shell__.Call(__push__, "#rf/shell/252").Call(list, 1)
  if !(list[2] == 1) {
    throw 0
  }
  len := __rf_shell__.Call(__push__, "#rf/shell/253").Call(list, 2, 3, 4)
  if !(len == 5) {
    throw 1
  }
  if !(list[3] == 2) {
...
shell_146() {
  list := [0, 1, 2]
  last := __rf_shell__.Call(__pop__, "#rf/shell/254").Call(list)
  if !(last == 2) {
    throw 0
  }
...
shell_147() {
  for __index_for__, fn in ["abs", "ceil", "floor", "max", "min", "round"] {
    if !(__rf_shell__.Call(__isFunction__, "#rf/shell/255").Call(__math__[__ci_shell__.Call(fn)])) {
...
shell_148() {
  string := "wow"
  n := __rf_shell__.Call(__length__, "#rf/shell/256").Call(string)
  if !(n == 3) {
    throw 3
  }
}
shell_149() {
  map := {a: 1, b: 2, c: 3}
  n := __rf_shell__.Call(__length__, "#rf/shell/257").Call(map)
  if !(n == 3) {
    throw 2
  }
}
shell_150() {
  list := [1, 2, 3]
  n := __rf_shell__.Call(__length__, "#rf/shell/258").Call(list)
  if !(n == 3) {
    throw 1
  }
}
shell_151() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/259").Call(__getColor__)) {
    throw "$.getColor is not a function"
  }
}
shell_152() {
  f := __rf_shell__.Call(__file__, "#rf/shell/260").Call("test.txt")
  text := "hello world"
  __rf_shell__.Call(f.remove, "#rf/shell/261").Call()
  if (__rf_shell__.Call(f.isExists, "#rf/shell/262").Call()) {
    throw "test.txt should not exist - 1"
  }
  __rf_shell__.Call(f.write, "#rf/shell/263").Call(text)
  if !(__rf_shell__.Call(f.isExists, "#rf/shell/264").Call()) {
    throw "test.txt should exist"
  }
  content := __rf_shell__.Call(f.read, "#rf/shell/265").Call()
  if !(content == text) {
    throw "content is not correct"
  }
  __rf_shell__.Call(f.remove, "#rf/shell/266").Call()
  if (__rf_shell__.Call(f.isExists, "#rf/shell/267").Call()) {
    throw "test.txt should not exist - 2"
  }
}
shell_153() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/268").Call(__file__)) {
    throw "__file__ is not a function"
  }
  f := __rf_shell__.Call(__file__, "#rf/shell/269").Call("test.txt")
  if !(__rf_shell__.Call(__isObject__, "#rf/shell/270").Call(f)) {
    throw "__file__() does not return an object"
  }
  for __index_for__, fn in ["append", "isExists", "read", "remove", "write"] {
    if !(__rf_shell__.Call(__isFunction__, "#rf/shell/271").Call(f[__ci_shell__.Call(fn)])) {
...
shell_156(list, args*) {
  if !(__rf_shell__.Call(__isArray__, "#rf/shell/272").Call(list)) {
    throw "$.unshift: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/273").Call(list)) . "'"
  }
...
shell_158(it) {
  return __result__ := "" . (__result__) . ", " . (__rf_shell__.Call(__toString__, "#rf/shell/274").Call(it)) . ""
}
shell_159(__forEach__, __trim__, ipt) {
  if (__rf_shell__.Call(__isString__, "#rf/shell/275").Call(ipt)) {
    return ipt
  }
  if (__rf_shell__.Call(__isNumber__, "#rf/shell/276").Call(ipt)) {
    return "" . (ipt) . ""
  }
  if (__rf_shell__.Call(__isArray__, "#rf/shell/277").Call(ipt)) {
    __result__ := ""
    __rf_shell__.Call(__forEach__, "#rf/shell/278").Call(ipt, Func("shell_158"))
    return "[" . (__rf_shell__.Call(__trim__, "#rf/shell/279").Call(__result__, " ,")) . "]"
  }
  if (__rf_shell__.Call(__isObject__, "#rf/shell/280").Call(ipt)) {
    __result__ := ""
    for key, value in ipt {
      __result__ := "" . (__result__) . ", " . (key) . ": " . (__rf_shell__.Call(__toString__, "#rf/shell/281").Call(value)) . ""
    }
    return "{" . (__rf_shell__.Call(__trim__, "#rf/shell/282").Call(__result__, " ,")) . "}"
  }
  throw "__toString__: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/283").Call(ipt)) . "'"
}
shell_160() {
  __forEach__ := __shell_module_84__
  __getType__ := __shell_module_27__
  __isArray__ := __shell_module_44__
  __isNumber__ := __shell_module_45__
  __isObject__ := __shell_module_26__
  __isString__ := __shell_module_46__
  __trim__ := __shell_module_80__
  __toString__ := Func("shell_159").Bind(__forEach__, __trim__)
  return __toString__
}
shell_161(list) {
  if !(__rf_shell__.Call(__isArray__, "#rf/shell/284").Call(list)) {
    throw "$.shift: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/285").Call(list)) . "'"
  }
  __first__ := list[1]
  list.RemoveAt(1)
  return __first__
...
shell_163(list, value*) {
  if !(__rf_shell__.Call(__isArray__, "#rf/shell/286").Call(list)) {
    throw "$.push: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/287").Call(list)) . "'"
  }
...
shell_165(list) {
  if !(__rf_shell__.Call(__isArray__, "#rf/shell/288").Call(list)) {
    throw "$.pop: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/289").Call(list)) . "'"
  }
  return list.Pop()
}
shell_166() {
...
shell_172(ipt) {
  if (__rf_shell__.Call(__isArray__, "#rf/shell/291").Call(ipt)) {
    return ipt.Length()
  }
  if (__rf_shell__.Call(__isObject__, "#rf/shell/292").Call(ipt)) {
    return ipt.Count()
  }
  if (__rf_shell__.Call(__isString__, "#rf/shell/293").Call(ipt)) {
    return StrLen(ipt)
  }
  throw "$.length: invalid type '" . (__rf_shell__.Call(__getType__, "#rf/shell/294").Call(ipt)) . "'"
}
shell_173() {
  __getType__ := __shell_module_27__
  __isArray__ := __shell_module_44__
...
shell_174() {
  string := "string"
  result := __rf_shell__.Call(__subString__, "#rf/shell/295").Call(string, 0)
  if !(result == string) {
    throw result
  }
  result := __rf_shell__.Call(__subString__, "#rf/shell/296").Call(string, 1)
  if !(result == "tring") {
    throw result
  }
  result := __rf_shell__.Call(__subString__, "#rf/shell/297").Call(string, 1, 2)
  if !(result == "t") {
    throw result
  }
  result := __rf_shell__.Call(__subString__, "#rf/shell/298").Call(string, 3, 5)
  if !(result == "in") {
    throw result
  }
}
shell_175() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/299").Call(__play__)) {
    throw "__play__ is not a function"
  }
}
shell_176() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/300").Call(__open__)) {
    throw "$.open is not a function"
  }
}
shell_177() {
  now := __rf_shell__.Call(__now__, "#rf/shell/301").Call()
  if !(__rf_shell__.Call(__isNumber__, "#rf/shell/302").Call(now)) {
    throw 0
  }
}
shell_178() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/303").Call(__noop__)) {
    throw 0
  }
}
shell_179() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/304").Call(__move__)) {
    throw "__move__ is not a function"
  }
}
shell_180() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/305").Call(__min__)) {
    throw "$.min is not a function"
  }
  result := __rf_shell__.Call(__min__, "#rf/shell/306").Call([1, 2, 3])
  if !(result == 1) {
    throw "$.min() does not return the correct result"
  }
}
shell_181() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/307").Call(__max__)) {
    throw "$.max is not a function"
  }
  result := __rf_shell__.Call(__max__, "#rf/shell/308").Call([1, 2, 3])
  if !(result == 3) {
...
shell_182() {
  string := "aloha"
  result := __rf_shell__.Call(__isString__, "#rf/shell/309").Call(string)
  if !(result) {
    throw 1
  }
}
shell_183() {
  map := {a: 1}
  result := __rf_shell__.Call(__isObject__, "#rf/shell/310").Call(map)
  if !(result) {
    throw 1
  }
}
shell_184() {
  n := 1
  result := __rf_shell__.Call(__isNumber__, "#rf/shell/311").Call(n)
  if !(result) {
    throw 1
  }
}
shell_185() {
  result := __rf_shell__.Call(__isFunction__, "#rf/shell/312").Call(__isFunction__)
  if !(result) {
    throw 1
  }
}
shell_186() {
  list := []
  result := __rf_shell__.Call(__isArray__, "#rf/shell/313").Call(list)
  if !(list) {
    throw 1
  }
  list := [1, 2, 3]
  result := __rf_shell__.Call(__isArray__, "#rf/shell/314").Call(list)
  if !(result) {
    throw 2
  }
}
shell_187() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/315").Call(__httpGet__)) {
    throw "$.get is not a function"
  }
}
shell_188() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/316").Call(__getPosition__)) {
    throw "__getPosition__ is not a function"
  }
}
shell_189() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/317").Call(__findImage__)) {
    throw 0
  }
}
shell_190() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/318").Call(__findColor__)) {
    throw 0
  }
}
shell_191() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/319").Call(__exit__)) {
    throw "$.exit is not a function"
  }
}
shell_192() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/320").Call(__confirm__)) {
    throw 0
  }
}
shell_193() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/321").Call(__click__)) {
    throw "$.click is not a function"
  }
}
shell_194() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/322").Call(__clearTimeout__)) {
    throw "$.clearTimeout is not a function"
  }
}
shell_195() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/323").Call(__clearInterval__)) {
    throw "$.clearInterval is not a function"
  }
}
shell_196() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/324").Call(__blockInput__)) {
    throw 0
  }
}
shell_197() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/325").Call(__beep__)) {
    throw 0
  }
}
shell_198() {
  if !(__rf_shell__.Call(__isFunction__, "#rf/shell/326").Call(__alert__)) {
    throw 0
  }
}
shell_199(this, callback) {
  WinWait, % this.exe
  if (callback) {
...
shell_201(this, style) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/329").Call()) {
    return
  }
  __rf_shell__.Call(__noop__, "#rf/shell/330").Call(style)
  WinSet, Style, % style, % this.exe
  return
}
shell_202(this, level) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/331").Call()) {
    return
  }
  __rf_shell__.Call(__noop__, "#rf/shell/332").Call(level)
  Process, Priority, % this.exe, % level
  return
}
shell_203(this) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/333").Call()) {
    return
  }
  WinRestore, % this.exe
  return
...
shell_207(this) {
  ...
  __object__ := __rf_shell__.Call(this.getBounds, "#rf/shell/338").Call()
  x := __object__["x"]
  y := __object__["y"]
...
shell_212(this) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/341").Call()) {
    return
  }
...
shell_214(this) {
  ...
  __rf_shell__.Call(__noop__, "#rf/shell/343").Call(name)
  WinActivate, % name
  return
}
shell_215() {
...
shell_217(this, __number__*) {
  return Min(__number__*)
}
shell_218(this, __number__*) {
  return Max(__number__*)
}
shell_219(this, __n__) {
  return Floor(__n__)
}
shell_220(this, __n__) {
  return Ceil(__n__)
}
shell_221(this, __n__) {
  return Abs(__n__)
}
shell_222(this, content) {
  __rf_shell__.Call(this.remove, "#rf/shell/344").Call()
  __rf_shell__.Call(this.append, "#rf/shell/345").Call(content)
  return
}
shell_223(this) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/346").Call()) {
    return
  }
...
shell_224(this) {
  if !(__rf_shell__.Call(this.isExists, "#rf/shell/347").Call()) {
    return ""
  }
  __result__ := ""
  FileRead, __result__, % this.source
  return __rf_shell__.Call(__replace__, "#rf/shell/348").Call(__result__, "`r", "")
}
shell_225(this) {
  return FileExist(this.source)
}
shell_226(this, content) {
  __rf_shell__.Call(__noop__, "#rf/shell/349").Call(content)
  FileAppend, % content, % this.source, UTF-8
  return
}
shell_227(text, iStart, iEnd := 0) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/350").Call(text)
  if !(__type__ == "string") {
...
shell_229(filename) {
  __rf_shell__.Call(__noop__, "#rf/shell/351").Call(filename)
  SoundPlay, % filename
  return
}
shell_230() {
...
shell_231(source) {
  __rf_shell__.Call(__noop__, "#rf/shell/352").Call(source)
  Run, % source
  return
}
shell_232() {
...
shell_233(p := "", speed := 0) {
  ...
  __rf_shell__.Call(__noop__, "#rf/shell/353").Call(speed)
...
shell_235(ipt) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/354").Call(ipt)
  if !(__type__ == "string") {
    return false
  }
  return true
...
shell_237(ipt) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/355").Call(ipt)
  if !(__type__ == "number") {
    return false
  }
  return true
...
shell_239(ipt) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/356").Call(ipt)
  if !(__type__ == "array") {
    return false
  }
  return true
...
shell_241(__toTuple__) {
  __array__ := [0, 0]
  __x__ := __array__[1]
  __y__ := __array__[2]
  MouseGetPos, __x__, __y__
  return __rf_shell__.Call(__toTuple__, "#rf/shell/357").Call([__x__, __y__])
}
shell_242() {
  __toTuple__ := __shell_module_81__
  return Func("shell_241").Bind(__toTuple__)
}
shell_243(source, start, end) {
  if !(start) {
    start := [0, 0]
  }
  if !(end) {
  ...
  __x__ := __array__[1]
  __y__ := __array__[2]
  __rf_shell__.Call(__noop__, "#rf/shell/358").Call(source)
...
shell_245(color, start, end, variation := 0) {
  if !(start) {
    start := [0, 0]
  }
  if !(end) {
  ...
  __x__ := __array__[1]
  __y__ := __array__[2]
  __rf_shell__.Call(__noop__, "#rf/shell/359").Call(color, variation)
...
shell_247(ipt) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/360").Call(ipt)
  if !(__type__ == "object") {
    return false
  }
  return true
...
shell_249(text, callback) {
  __rf_shell__.Call(__noop__, "#rf/shell/361").Call(text, callback)
  MsgBox, 0x4,, % text
  IfMsgBox Yes
    callback.Call(true)
  else
...
shell_251(key := "left") {
  key := __rf_shell__.Call(__replace__, "#rf/shell/362").Call(key, "-", "")
  key := __rf_shell__.Call(__replace__, "#rf/shell/363").Call(key, ":", " ")
  Click, % key
  return
}
shell_252() {
...
shell_253(ipt) {
  __type__ := __rf_shell__.Call(__getType__, "#rf/shell/364").Call(ipt)
...
shell_255(message) {
  __rf_shell__.Call(__noop__, "#rf/shell/365").Call(message)
  MsgBox, % message
  return
}
shell_256() {
...
shell_257() {
  string := "string"
  result := __rf_shell__.Call(__startsWith__, "#rf/shell/366").Call(string, "s")
  if !(result) {
    throw 1
  }
  result := __rf_shell__.Call(__startsWith__, "#rf/shell/367").Call(string, "t")
  if (result) {
    throw 2
  }
}
shell_258() {
  a := "alt + f4"
  b := __rf_shell__.Call(__replace__, "#rf/shell/368").Call(a, " ", "")
  if !(b == "alt+f4") {
    throw b
  }
}
shell_259() {
  a := " 123 "
  b := __rf_shell__.Call(__replace__, "#rf/shell/369").Call(a, " ", "")
  if !(b == "123") {
    throw b
  }
}
...
shell_261() {
  map := {n: 0}
  add := __rf_shell__.Call(__once__, "#rf/shell/370").Call(Func("shell_260").Bind(map))
  __rf_shell__.Call(add, "#rf/shell/371").Call()
  if !(map.n == 1) {
    throw 0
  }
  __rf_shell__.Call(add, "#rf/shell/372").Call()
  if !(map.n == 1) {
    throw 1
  }
}
shell_262() {
  n := __rf_shell__.Call(__mod__, "#rf/shell/373").Call(5, 2)
  if !(n == 1) {
    throw n
  }
  n := __rf_shell__.Call(__mod__, "#rf/shell/374").Call(7, 5)
  if !(n == 2) {
    throw n
  }
}
shell_263() {
  result := __rf_shell__.Call(__lte__, "#rf/shell/375").Call(1, 2)
  if !(result) {
    throw 0
  }
  result := __rf_shell__.Call(__lte__, "#rf/shell/376").Call(2, 1)
  if (result) {
    throw 1
  }
  result := __rf_shell__.Call(__lte__, "#rf/shell/377").Call(1, 1)
  if !(result) {
    throw 2
  }
}
shell_264() {
  result := __rf_shell__.Call(__lt__, "#rf/shell/378").Call(1, 2)
  if !(result) {
    throw 0
  }
  result := __rf_shell__.Call(__lt__, "#rf/shell/379").Call(2, 1)
  if (result) {
    throw 1
  }
  result := __rf_shell__.Call(__lt__, "#rf/shell/380").Call(1, 1)
  if (result) {
    throw 2
  }
}
shell_265() {
  result := __rf_shell__.Call(__gte__, "#rf/shell/381").Call(2, 1)
  if !(result) {
    throw 0
  }
  result := __rf_shell__.Call(__gte__, "#rf/shell/382").Call(1, 2)
  if (result) {
    throw 1
  }
  result := __rf_shell__.Call(__gte__, "#rf/shell/383").Call(1, 1)
  if !(result) {
    throw 2
  }
}
shell_266() {
  result := __rf_shell__.Call(__gt__, "#rf/shell/384").Call(2, 1)
  if !(result) {
    throw 0
  }
  result := __rf_shell__.Call(__gt__, "#rf/shell/385").Call(1, 2)
  if (result) {
    throw 1
  }
  result := __rf_shell__.Call(__gt__, "#rf/shell/386").Call(1, 1)
  if (result) {
    throw 2
  }
}
shell_267() {
  type := __rf_shell__.Call(__getType__, "#rf/shell/387").Call(42)
  if !(type == "number") {
    throw type
  }
  type := __rf_shell__.Call(__getType__, "#rf/shell/388").Call(__getType__)
  if !(type == "function") {
    throw type
  }
  type := __rf_shell__.Call(__getType__, "#rf/shell/389").Call([1, 2, 3])
  if !(type == "array") {
    throw type
  }
  type := __rf_shell__.Call(__getType__, "#rf/shell/390").Call({a: 1, b: 2, c: 3})
  if !(type == "object") {
    throw type
  }
  type := __rf_shell__.Call(__getType__, "#rf/shell/391").Call({0: ""})
  if !(type == "object") {
    throw type
  }
  type := __rf_shell__.Call(__getType__, "#rf/shell/392").Call({0: "", 1: "a", 2: "b", 3: "c"})
  if !(type == "object") {
    throw type
  }
}
shell_268() {
  list := [1, 2, 3]
  n := __rf_shell__.Call(__first__, "#rf/shell/393").Call(list)
  if !(n == 1) {
    throw n
  }
}
shell_269() {
  a := {a: 1, b: 2}
  __rf_shell__.Call(__delete__, "#rf/shell/394").Call(a, "a", "b")
  if !(a.a == "" && a.b == "") {
    throw 0
  }
}
shell_270() {
  a := {a: 1, b: 2}
  __rf_shell__.Call(__delete__, "#rf/shell/395").Call(a, "a")
  if !(a.a == "") {
    throw 0
  }
}
shell_271() {
  ...
  c := 3
  d := -4
  result := __rf_shell__.Call(__add__, "#rf/shell/396").Call(a)
  if !(result == 1) {
    throw result
  }
  result := __rf_shell__.Call(__add__, "#rf/shell/397").Call(a, b, c)
  if !(result == 6) {
    throw result
  }
  result := __rf_shell__.Call(__add__, "#rf/shell/398").Call(a, b, c, d)
  if !(result == 2) {
    throw result
  }
}
...
shell_301(value, other) {
  return value < other
}
shell_302() {
  return Func("shell_301")
}
shell_303(url, callback) {
  try {
    whr := ComObjCreate("WinHttp.WinHttpRequest.5.1")
    whr.Open("GET", url, true)
    whr.Send()
    whr.WaitForResponse()
    __rf_shell__.Call(callback, "#rf/shell/400").Call(whr.ResponseText)
  } catch {
    __rf_shell__.Call(callback, "#rf/shell/401").Call("")
  }
  return
}
shell_304() {
...
shell_315(list, callback) {
  for __i__, __item__ in list {
    __i__ := __i__ - 1
    __rf_shell__.Call(callback, "#rf/shell/402").Call(__item__, __i__)
  }
  return
}
shell_316() {
